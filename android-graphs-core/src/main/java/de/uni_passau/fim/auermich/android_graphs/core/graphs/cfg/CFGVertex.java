 ...
 * A vertex in a CFG.
 */
public class CFGVertex extends Vertex implements Comparable<CFGVertex>, Cloneable {

    private static final Logger LOGGER = LogManager.getLogger(CFGVertex.class);
    ...
    public CFGVertex clone() {

        try {
            CFGVertex vertexClone = (CFGVertex) super.clone();
